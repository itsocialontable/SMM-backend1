...
instagramLogin: {
  ...
  // reference/consistency ke liye rakha hai.
  tokenUrl: "https://api.instagram.com/oauth/access_token",
  // FIX v23: pehle sirf basic + content_publish maangi ja rahi thi —
  // isliye connected accounts ke paas insights (likes/comments/reach)
  // padhne ki permission hi nahi hoti thi, aur analytics sync
  // "Application does not have permission for this action" deta tha.
  // instagram_business_manage_insights add kiya — ab naye connect ke
  // baad token me ye permission bhi hogi.
